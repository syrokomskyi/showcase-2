/**
 * Тестовые данные для проверки функциональности EnhancedArticle
 */

// Пример текста из задания - полный текст статьи
export const fullTestText = `Der erste Herbstnebel legt sich morgens über die Gärten, und in der Küche beginnt die schönste Zeit des Jahres – zumindest für alle, die gerne kochen. Doch während Rechtshänder einfach zum Dosenöffner greifen, kämpfen wir Linkshänder noch immer mit Werkzeugen, die uns das Leben unnötig schwer machen. Zeit, das zu ändern.
...
export const complexTestCases = {
  // Смешанный контент
  mixedContent: `# Заголовок статьи

Это первый параграф статьи.
...
Заключительный параграф.`,
  ...
  // Вложенные структуры
  nestedStructures: `# Главный заголовок

## Раздел 1

Параграф в разделе 1.
...
Еще один параграф.`,
  ...
  withEmptyLines: `# Заголовок


Параграф после пустых строк.
