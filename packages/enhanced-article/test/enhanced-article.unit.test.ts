...
import { simpleTestCases, complexTestCases, fullTestText, expectedResults } from './fixture';
...
describe('EnhancedArticle', () => {
  ...
  describe('Single Structure Parsing', () => {
    ...
    it('should parse single guest block correctly', () => {
      ...
      expect((structures[0] as any).getGuestId()).toBe('olm-g-e56b84bb-b432-4bcb-a9a2-fef7afd58c8c');
    });
  ...
  describe('Multiple Guest Blocks', () => {
    it('should parse multiple guest blocks correctly', () => {
      ...
      expect((structures[0] as any).getGuestId()).toBe('olm-g-e56b84bb-b432-4bcb-a9a2-fef7afd58c8c');
      expect((structures[1] as any).getGuestId()).toBe('olm-g-768af193-e254-4c27-ab58-c614434872b1');
    });
  });
...
+ Second plus item`;
  ...
  describe('Real Data Test', () => {
    it('should parse full test text correctly', () => {
      ...
      Object.entries(expectedResults.fullTextTypes).forEach(([type, expectedCount]) => {
